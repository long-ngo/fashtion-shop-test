            ...
            <div className="container">
                ...
                <div className="row menu-container">
                    ...
                    <div className="col-lg-6 menu-item filter-starters">
                        ...
                        <div className="menu-ingredients">
                            A delicate crab cake served on a toasted roll with
                    ...
                    <div className="col-lg-6 menu-item filter-specialty">
                        ...
                        <div className="menu-ingredients">
                            Grilled chicken with provolone, artichoke hearts,
                            and roasted red pesto
                        </div>
                    </div>
                    <div className="col-lg-6 menu-item filter-starters">
                        <div className="menu-content">
                    ...
                    <div className="col-lg-6 menu-item filter-salads">
                        ...
                        <div className="menu-ingredients">
                            Fresh spinach, crisp romaine, tomatoes, and Greek
                            olives
                        </div>
                    </div>
                    <div className="col-lg-6 menu-item filter-salads">
                        ...
                        <div className="menu-ingredients">
                            Fresh spinach with mushrooms, hard boiled egg, and
